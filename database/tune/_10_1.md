...
# [2021-07-18 18:16:31] 37,810 rows retrieved starting from 1 in 4 s 21 ms (execution: 2 s 667 ms, fetching: 1 s 354 ms)
```
...
# [2021-07-18 18:18:57] 37,810 rows retrieved starting from 1 in 2 s 230 ms (execution: 14 ms, fetching: 2 s 216 ms)
```
...
![튜닝 된 실행 계획](../images/executeplan_97.png)
...
# [2021-07-18 18:32:04] 180 rows retrieved starting from 1 in 161 ms (execution: 79 ms, fetching: 82 ms)
```
...
![안티 세미 조인 실행 계획](../images/executeplan_99.png)
